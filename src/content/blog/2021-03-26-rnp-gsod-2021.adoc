...
First created in 2017, RNP is now used by Mozilla's https://www.thunderbird.net/[Thunderbird] to
...
https://www.mozilla.org/en-US/moss/[Mozilla Open Source Support (MOSS)]
...
and the https://web.archive.org/web/20210327014434/https://ec.europa.eu/programmes/horizon2020/[EU Horizons 2020] program
