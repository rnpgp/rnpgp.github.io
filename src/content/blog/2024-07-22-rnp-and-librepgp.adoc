...
As the developer of RNP, https://www.ribose.com[Ribose] works closely with https://g10code.com[g10 Code], the developer of
GnuPG, and https://intevation.de[Intevation], the developer of Gpg4win, the most prevalent OpenPGP
